...
\Qref{\LuaTeX{}}{Q-luatex}, which both have 256 math alphabets
...
running at all.
Before loading \Package{bm}),  then steadily reduce the bold
...
\FontName{Mathtime Plus}) that feature a heavy symbol weight,
you may want to suppress all use of heavy families by \Package{bm} by
similarly setting
\begin{quote}
\begin{verbatim}
  \newcommand{\hmmax}{0}
